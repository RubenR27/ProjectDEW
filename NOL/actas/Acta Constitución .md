...
| Carmen Paredes | Secretaria | cparram@etsinf.upv.es |
...
Se acuerda que la secretaria del equipo será: **Carmen Paredes**
Será la persona encargada de redactar y almacenar las actas de las reuniones realizadas durante el proyecto.
...
* Se acuerda mantener una participación activa y constante.
* Todos los miembros se comprometen a colaborar en el desarrollo del proyecto.
* En caso de problemas de disponibilidad, se comunicará al resto del equipo con antelación.
* Si hay tareas por finalizar, se finalizarán antes de empezar la siguiente sesión.
...
* Se han acordado todos los puntos tratados en el acta.
* Se acuerda realizar commits frecuentes para mantener actualizado el repositorio.
* Algunos integrantes han comenzado a configurar el entorno de desarrollo para próximas sesiones.
