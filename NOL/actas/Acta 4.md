...
## Objetivos
1. Remodelación y junte de las interfaces Bienvenida y LogIn.
2. Creación del javaScript.
3. Pruebas del script.
4. Solucionar problemas con LogIn. 

---

## Notas de la Sesión

*   **Punto 1:** Se han modificado las interfaces para enlazar la interfaz Bienvenida y LogIn.
*   **Punto 2:** Se ha creado el JavaScript para la interfaz de Bienvenida y Lista de Asignaturas.
*   **Punto 3:** Se ha realizado una serie de pruebas para verificar el funcionamiento del script.
*   **Punto 4:** Se ha continuado solucionando los problemas relacionados con el LogIn. 
