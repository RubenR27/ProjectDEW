    ...
    <div class="contenedor-principal">
        ...
        <%
            for (int i = 0; i < asigs.length(); i++) {
                ...
                String acr      = a.optString("acronimo", "");
                String nomAsig  = a.optString("nombre", "");
                int curso       = a.optInt("curso", 0);
                String cuatri   = a.optString("cuatrimestre", "");
                double creditos = a.optDouble("creditos", 0);
